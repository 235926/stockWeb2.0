...
/**
 * @description: 企业信息管理 - 业务办理 - 企业图谱
 * @param {*} data
 * @return {*}
 */
export const getBusinessEnterpriseMap = (data) => {
	return request({
		url: '/CMPY_BASE_INFO.getImgData.do',
		method: 'get',
		params: data,
	})
}
...
/**
 * @description: 企业信息管理 - 业务办理 - 变更记录
 * @param {*} data
 * @return {*}
 */
export const getBusinessChangeRecord = (data) => {
	return request({
		url: '/CMPY_CHANGE_LOG.query.do',
		method: 'get',
		params: data,
	})
}
...
/**
 * @description: 企业信息管理 - 业务办理 - 投资企业查询
 * @param {*} data
 * @return {*}
 */
export const getBusinessInvestment = (data) => {
	return request({
		url: '/CMPY_GD.investMan.do',
		method: 'get',
		params: data,
	})
}
